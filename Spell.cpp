...
void shadow_word_pain_release(Spell_Formula *formula, Game_State *game_state, Character *caster, Scene_Graph* scene)
{
  ASSERT(caster);
...
void corruption_release(Spell_Formula *formula, Game_State *game_state, Character *caster, Scene_Graph* scene)
{
  ASSERT(caster);
  Character *target = game_state->get_character(caster->cast_target);
  ASSERT(target);
...
void frostbolt_release(Spell_Formula *formula, Game_State *game_state, Character *caster, Scene_Graph* scene)
{
...
void blink_release(Spell_Formula *formula, Game_State *game_state, Character *caster, Scene_Graph* scene)
{
  ASSERT(caster);
...
void sprint_release(Spell_Formula *formula, Game_State *game_state, Character *caster, Scene_Graph* scene)
{
  ASSERT(caster);
...
void icy_veins_release(Spell_Formula *formula, Game_State *game_state, Character *caster, Scene_Graph* scene)
{
  ASSERT(caster);
...
void seed_of_corruption_release(Spell_Formula *formula, Game_State *game_state, Character *caster, Scene_Graph* scene)
{
...
void demonic_circle_summon_release(
    Spell_Formula *formula, Game_State *game_state, Character *caster, Scene_Graph* scene)
{
  ASSERT(caster);
