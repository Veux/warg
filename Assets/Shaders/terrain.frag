...
void main()
{
  ...
  */
  ...
  vec3 ambient_diffuse = Kd * irradiance * m.albedo ;/// PI; //appears to be correct without dividing by pi as in direct lighting, as it seems to be baked in to the irradiance map
