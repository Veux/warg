...
void main()
{
  ...
  float med_chance_true = float(random(vec2(p)+vec2(sin(time))) <     cubertdt*0.65f && random(vec2(p)+vec2(cos(2.1f*time)) ) <  cubertdt*0.52f && random(vec2(p)+vec2(cos(1.1f*time)) ) <   cubertdt*0.5f);
